    ...
    <div class="container-fluid tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">
               Reklamcının Tarihçesi
            </h2>
        </div>

        <div class="row tm-mb-74 tm-row-1640">            
            <div class="col-lg-5 col-md-6 col-12 mb-3">
                <img src="img/igu_about.png" alt="Image" class="img-fluid">
            </div>
            <div class="col-lg-7 col-md-6 col-12">
                <div class="tm-about-img-text">
                    <p class="mb-4">
                    Reklamcı sitesi 4 arkadaşın birbirleriyle konuşurken, 1 arkadaşın aniden neden reklamcı sitesi yapmıyoruz demesiyle ortaya çıkmıştır.
                    Ve aniden siteye yapım aşamaları belirlenip, yapılmaya başlanmıştır.
                   </p>
                    <p>
                        Reklamcı sitesi İstanbul Gelişim Üniversitesinin Bilişim Teknolojileri bölümünde ki Web/İnternet Programcılığı dersinde ki 5 öğrenci nin birleşimi ile 2022-2023 döneminde yapılmaya hazır hale getirilmiştir.
                    </p>
                </div>                
            </div>
        </div>
