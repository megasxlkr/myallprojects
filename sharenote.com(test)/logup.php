...
try
{
    ...
    {
        if(empty($_POST["sirket_kullaniciadi"]) || empty($_POST["sirket_parola"]))
        {
            $message = '<label>All fields are required</label>';
        }
        else
        {
            $query = "SELECT * FROM sirket_kayitdefteri WHERE sirket_kullaniciadi = :sirket_kullaniciadi AND sirket_parola = :sirket_parola";
            ...
            if($count > 0)
            {
                $_SESSION["sirket_kullaniciadi"] = $_POST["sirket_kullaniciadi"];
                ...
                <div class="card-body">
                    ...
                    <form action="logup.php" method="post">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Giriş Yap" name="login" class="btn float-right login_btn">
                        </div>
                    </form>
                </div>
            </div>
