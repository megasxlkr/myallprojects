            ...
            <div class="card-body">
                ...
                <form action="register.php" method="post">
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="text" name="sirket_adi" class="form-control" placeholder="Şirket Adınız">    
                    </div>
                    <div class="input-group form-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                        </div>
                        <input type="text" name="sirket_kullaniciadi" class="form-control" placeholder="Kullanıcı Adınız">    
                    </div>
                    <div class="input-group form-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                        </div>
                        <input type="text" name="sirket_adresi" class="form-control" placeholder="Şirket Adresiniz">    
                    </div>
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="password" name="sirket_parola" class="form-control" placeholder="Şifreniz">
                    </div>
                    ...
                    <div class="form-group">
                        <input type="submit" name="kayitol" value="Kaydol" class="btn float-right login_btn">
                    </div>
...
if (isset($_POST['kayitol'])) {
    ...
    $sirket_kullaniciadi=$_POST["sirket_kullaniciadi"];
    $sirket_adresi=$_POST["sirket_adresi"];
    $sirket_parola=$_POST["sirket_parola"];

    $kaydet = $db -> exec("insert into sirket_kayitdefteri (sirket_adi,sirket_kullaniciadi,sirket_adresi,sirket_parola)VALUES('$sirket_adi','$sirket_kullaniciadi','$sirket_adresi','$sirket_parola')");
