    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-1 " aria-current="page" href="uyesirketliste.php">Üye Şirketler Liste</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-2" href="adminindex.php">Profil</a>
                </li>
                 
                <li class="nav-item">
                    <a class="nav-link nav-link-2" href="adminreklamyayin.php">Reklam Yayınla</a>
                </li>
                <!--
...
<br>
<?php
echo '<h3>Login Success, Welcome Admin - '.$_SESSION["ka"].'</h3>';
// echo '<br /><br /><a href="logoff.php">Logout</a>';
...
if (isset($_POST['listeleme'])) {
    try {
        ...
        $baglanti = new PDO("mysql:host=localhost;dbname=reklam_uye","root","");
        $baglanti->exec("SET NAMES utf8");
        $baglanti->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

        $sorgu = $baglanti->query("SELECT id,sirket_adi, sirket_kullaniciadi, sirket_adresi FROM sirket_kayitdefteri");

        while ($cikti = $sorgu->fetch(PDO::FETCH_ASSOC)) {
            echo "<table>";
            echo "string";
            echo "Şirket Kayıt No" . $cikti["id"] . "<br \>  Şirket Adı: " . $cikti["sirket_adi"] . "<br /> Sirket Kullanıcı Adı: " . $cikti["sirket_kullaniciadi"] . "<br /> Şirket Adresi: " . $cikti["sirket_adresi"] . "<hr />";
...
<form method="post" action="uyesirketliste.php">
    <input type="submit" name="listeleme" value="Şirket Lİstesi" class="btn float-right login_btn">
