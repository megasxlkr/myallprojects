...
<?php echo '<h5>Login Success, Welcome Admin - '.$_SESSION["ka"].'</h5>'; // echo '<br /><br /><a href="logoff.php">Logout</a>'; ?>

<!--  React ile time kullanımı -->
<div id="root"></div>
...
<div class="text-center"><a href="create.php">Create a new post</a> </div>

   <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">

        <div id="id01">Yazı buraya gelicek veri çekip..</div>

        <script type="text/babel">

        const name = 'Gönderilerim';
        ReactDOM.render(
        <h1>Yayında ki {name}!</h1>,
    ...
    <div class="card text-white bg-dark mt-5">
        <div class="card-body style=width: 55rem;">
            ...
            <p class="card-text"><?php echo $q['content']?></p>
                        <a href="viewpost.php?id=<?php echo $q['id'] ?>" class="btn btn-light">Read More..<span class="text-danger">&rarr;</a>
        </div>
    </div> 
</div>
