...
if (isset($_POST['listeleme'])) {
    try {
        ...
        $sorgu = $baglanti->query("SELECT id,sayfa_baslik, sayfa_tur, sirket_adres, sirket_bilgisi, img_name, image FROM reklam");

        while ($cikti = $sorgu->fetch(PDO::FETCH_ASSOC)) {
            echo "Sayfa Başlık" . $cikti["sayfa_baslik"] . "<br \>  Şirket Türü: " . $cikti["sayfa_tur"] . "<br /> Sirket Bilgisi: " . $cikti["sirket_bilgisi"] . "<br /> Şirket Adresi: " . $cikti["sirket_adres"] . "<hr />";
        }
...
?>
<form method="post" action="reklamlar.php">
    <input type="submit" name="listeleme" value="Reklamlar" class="btn float-right login_btn">
