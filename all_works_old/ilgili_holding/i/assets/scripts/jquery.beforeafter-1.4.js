...
(function($){
	$.fn.extend({ 
		...
		var randID =  Math.round(Math.random()*100000000);
			...
			$(obj).prepend('<div id="dragwrapper'+randID+'"><div id="drag'+randID+'"><img width="40" height="40" style="margin-left:-16px;" alt="handle" src="i/assets/images/handle.png" id="handle'+randID+'" /></div></div>'); // Create drag handle
