	...
	<div class="entry clearfix">
		<?php if( $format == '' || $format == 'image' ){ ?>
			...
			<div class="entry-content">				
				<div class="content-top">
					...
					<div class="entry-meta">
						<span class="entry-author">
							<i class="fa fa-user"></i><?php esc_html_e('Post By:', 'furnicom'); ?> <?php the_author_posts_link(); ?>
						</span>
						<span class="entry-comment">
							<a href="<?php comments_link(); ?>"><i class="fa fa-comments"></i><?php echo $post-> comment_count .  ( ($post-> comment_count) > 1 ? esc_html__('  Comments', 'furnicom') : esc_html__('  Comment', 'furnicom')); ?></a>
						</span>
					</div>
					<?php if(has_tag()) :?>
				...
				<div class="readmore"><a href="<?php echo get_permalink($post->ID)?>"><i class="fa fa-caret-right"></i><?php esc_html_e('Read More', 'furnicom'); ?></a></div>
			</div>
		<?php } elseif( !$format == ''){?>
