     ...
     <ul>
       ...
       <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
		...
		<div class="entry">
			<div class="entry-top">
				...
				<div class="entry-meta">
					...
					<span class="entry-comment">
						<?php echo $post->comment_count .'<span>'. esc_html__(' comments', 'furnicom').'</span>'; ?>
					</span>
					<span class="entry-view">
						<?php echo getPostViews(get_the_ID()). '<span>'.esc_html__(' Views','furnicom').'</span>'; ?> 
					</span>
			...
			<a href="<?php the_permalink() ?>" class="entry-buttom"><?php esc_html_e( 'READ MORE', 'furnicom' );?></a>
			<?php the_tags( '<div class="entry-meta-tag"><span class="fa fa-tag"></span>', ', ', '</div>' ); ?>
			<?php wp_link_pages( array( 'before' => '<div class="page-links"><span>' . esc_html__( 'Pages:', 'furnicom' ).'</span>', 'after' => '</div>' ) ); ?>
		</div>
	</div>
<?php endwhile; ?>
</div>
