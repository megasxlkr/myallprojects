jQuery(document).ready(function($){
	...
	jQuery("img[src='']").attr("src", furnicom_menu_upload.url);
	
	jQuery('.furnicom-menu-upload').click(function() {
		header_clicked = true;
	...
	jQuery('.furnicom-menu-upload-remove').click(function(){
		$relid = jQuery(this).attr('rel-id');
		jQuery('#'+$relid).val('');
		jQuery(this).prev().fadeIn('fast');
		jQuery(this).prev().prev().fadeOut('fast', function(){jQuery(this).attr("src", furnicom_menu_upload.url);});
