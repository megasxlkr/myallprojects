<?php
class Furnicom_Options_button_set extends Furnicom_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_style('furnicom-opts-jquery-ui-css');

		wp_enqueue_script(
			'furnicom-opts-field-button_set-js', 
			Furnicom_OPTIONS_URL.'fields/button_set/field_button_set.js', 
