...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('showposts') ); ?>"><?php esc_html_e('Number of Posts', 'furnicom')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('length') ); ?>"><?php esc_html_e('Length of excerpt', 'furnicom')?></label>
	<br />
	<input class="widefat"
