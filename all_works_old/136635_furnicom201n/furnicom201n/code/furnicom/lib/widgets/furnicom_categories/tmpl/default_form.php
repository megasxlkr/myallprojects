...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('categories') ); ?>"><?php esc_html_e('Categories Name', 'furnicom')?></label>
	<br />
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('number') ); ?>"><?php esc_html_e('Number of Categories', 'furnicom')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('exclude') ); ?>"><?php esc_html_e('Exclude', 'furnicom')?></label>
	<br />
	<input class="widefat"
