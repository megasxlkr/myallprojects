...
<div class="top-form top-form-minicart furnicom-minicart-style2 pull-right">
	<div class="top-minicart-icon pull-right">
		...
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_html_e('View your shopping cart', 'furnicom'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>';?></a>
