...
class discovery_Welcome {
	...
	public function discovery_welcome_admin_notice() {
		?>
			<div class="updated notice is-dismissible">
				<p><?php echo sprintf( esc_html__( 'Thanks for choosing Discovery! Learn how to get the most out of your new theme on the %swelcome screen%s.', 'discovery' ), '<a href="' . esc_url( admin_url( 'themes.php?page=discovery-welcome' ) ) . '">', '</a>' ); ?></p>
				<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=discovery-welcome' ) ); ?>" class="button" style="text-decoration: none;"><?php _e( 'Get started with Discovery', 'discovery' ); ?></a></p>
			</div>
		<?php
	}
	...
	public function discovery_welcome_register_menu() {
		add_theme_page( 'Discovery Theme Welcome Page', 'Discovery Theme', 'read', 'discovery-welcome', array( $this, 'discovery_welcome_screen' ) );
	}
