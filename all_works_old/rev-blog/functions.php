...
function ocdi_import_files() {
  return array(
    array(
      'import_file_name'           => 'Ornek Icerik',
      'categories'                 => array( 'Category 1', 'Category 2' ),
      'import_file_url'            => 'http://ucretsiz.wordpresstema.com/ornek/icerik.xml',
      'import_widget_file_url'     => 'http://ucretsiz.wordpresstema.com/ornek/bilesen.wie',
      'import_customizer_file_url' => 'http://ucretsiz.wordpresstema.com/ornek/ozellestir.dat',
      'import_preview_image_url'   => ' http://ucretsiz.wordpresstema.com/test1/wp-content/themes/Ucretsiz-WT-discovery/screenshot.png',
      'import_notice'              => __( 'Bu demosu ice aktardiktan sonra, logoyu ayri ayarlamaniz gerekir..', 'your-textdomain' ),
      'preview_url'                => 'http://ucretsiz.wordpresstema.com/test1/',
    ),
  );
}
...
require( get_template_directory() . '/plugins/example.php' );
