	...
	<footer id="colophon" class="site-footer">
		...
		<div id="site-bottom" class="clear">
			...
			<div class="site-info">
				...
				&copy; <?php echo date("o"); ?> <a href="<?php echo home_url(); ?>"><?php echo get_bloginfo('name'); ?></a><br><a href="https://www.wordpresstema.com" target="_blank">Wordpress</a> ile güçlendirilmiştir.
