...
function gltheme_theme_customizer( $wp_customize ) {
	...
	*/
	...
	border-radius: 5px;
	padding: 5px;text-decoration: none;" href="https://ltheme.com/project/lt-bycoin-single-page-free-responsive-one-page-bitcoin-wordpress-theme/" target="_blank" title="Get full website like demo with PRO version">' . __( 'Get PRO License', 'gltheme' ) . '</a>
